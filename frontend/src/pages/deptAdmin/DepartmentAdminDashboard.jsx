        ...
        <>
          <div className="stats-grid">
            <div className="stat-card">
              <div className="stat-info">
                ...
                <div className="stat-value">{metrics?.newRequests || 0}</div>
              </div>
            ...
            <div className="stat-card">
              <div className="stat-info">
                ...
                <div className="stat-value">{metrics?.slaAtRisk || 0}</div>
              </div>
            ...
            <div className="stat-card">
              <div className="stat-info">
                ...
                <div className="stat-value">{metrics?.inProgress || 0}</div>
              </div>
          ...
          >
            <div>
              ...
              <p style={{ color: 'var(--text-muted)', fontSize: '14px' }}>
                Review active queue items, inspect data transformations, and process verified citizen applications.
              </p>
            </div>
            <button
              type="button"
              className="btn btn-primary"
              onClick={() => navigate('deptadmin_queue')}
            >
              <ListOrdered size={16} />
