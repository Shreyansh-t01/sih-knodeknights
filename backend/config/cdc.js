...
const fieldEventMap = Object.freeze({
  ...
  address_line1: 'Address_Update',
  address_line2: 'Address_Update',
  village_or_ward: 'Address_Update',
  city: 'Address_Update',
  district: 'Address_Update',
  state: 'Address_Update',
  pincode: 'Address_Update',
  name: 'Name_Update',
  ...
  family_annual_income: 'Income_Update',
